...
import { Shield, Lock, User, Eye, EyeOff, ShieldCheck, Monitor } from "lucide-react";
...
/**
 * Get client IP for device locking
 */
...
export default function Login() {
  ...
  // Admin login - uses the built-in OAuth flow for admin users
    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md px-6">
        ...
        <div className="glass rounded-2xl p-8">
          <Tabs value={tab} onValueChange={(v) => setTab(v as "client" | "admin")}>
            <TabsList className="w-full mb-6 bg-secondary/30">
            ...
            <TabsContent value="admin">
              <form onSubmit={handleSubmitAdmin} className="space-y-5">
                <div className="text-center mb-4">
                  <ShieldCheck className="w-12 h-12 text-gold mx-auto mb-3" />
