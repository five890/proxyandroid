...
export const SITE_CONFIG = {
  name: "Shelby Community",
  fullName: "Shelby Community",
  description: "Plataforma exclusiva de acesso premium. Controle total, proteção por dispositivo e distribuição segura.",
  shortDescription: "Portal de Acesso Proxy",
